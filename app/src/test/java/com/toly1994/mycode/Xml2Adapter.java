...
public class Xml2Adapter {
    ...
    public void main() {
        //你的布局xml所在路径
        File file = new File("I:\\Java\\Android\\APL\\MyCode\\app\\src\\main\\res\\layout\\item_a_card.xml");
        //你的Adapter的java类放在哪个包里
        File out = new File("I:\\Java\\Android\\APL\\MyCode\\app\\src\\main\\java\\com\\toly1994\\mycode\\view\\adapter");
        //你的Adapter的名字--不要加.java
        String name = "HomeAdapter";
